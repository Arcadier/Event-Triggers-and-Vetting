(function(){
    ...
    $(document).ready(function(){
        ...
        if(pathname.indexOf(list) > -1){
            ...
            var settings = {
                "url": "http://"+baseUrl+"/api/v2/plugins/"+packageId+"/custom-tables/edit_cache/",
                "method": "GET"
            };
        ...
        function saveItem(id){
            ...
            var cache_settings = {
                "url": "http://"+baseUrl+"/api/v2/plugins/"+packageId+"/custom-tables/edit_cache/rows",
                "method": "POST",
                "async": false,
                "headers": {
                    "Content-Type": "application/json"
        ...
        function update_cache_entry(row, i_name){
            ...
            var settings = {
                "url": "http://"+baseUrl+"/api/v2/plugins/"+packageId+"/custom-tables/edit_cache/rows/"+row,
                "method": "PUT",
                "headers": {
                  "Content-Type": "application/json"
                },
